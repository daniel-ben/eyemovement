...
let rightEye = document.querySelector('[data-right-eye]');
let rightPupil = document.querySelector('[data-right-pupil]');
let leftEye = document.querySelector('[data-left-eye]');
let leftPupil = document.querySelector('[data-left-pupil]');
